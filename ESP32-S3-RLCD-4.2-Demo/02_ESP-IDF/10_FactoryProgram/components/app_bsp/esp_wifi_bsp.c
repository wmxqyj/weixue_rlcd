...
void espwifi_init(void)
{
    ...
    // FactoryProgram only scans nearby access points. Keep credentials empty in
    // source control; a future network feature should load them from provisioning
    // or local NVS instead of embedding secrets in the firmware repository.
